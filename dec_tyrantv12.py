...
def signal_handler(signum, frame):
    ...
    print(f"  {Colors.WHITE}   Thanks for using my codm checker! - @sinvy888{Colors.RESET}")
    print(f"  {Colors.LIGHTCYAN_EX}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{Colors.RESET}")
    print()
    os._exit(0)
...
class LiveStats:
    ...
    def display_stats(self):
        ...
        return (
            f"\n{cyan}╔═══════════════════════════════════════════════════════════════════╗{reset}\n"
            f"{cyan}║{reset}  {yellow}LIVE STATISTICS{reset} {gray}|{reset} {white}TyraCutiee - @sinvy888{reset}                       {cyan}║{reset}\n"
            f"{cyan}╠═══════════════════════════════════════════════════════════════════╣{reset}\n"
            ...
            f"{cyan}╚═══════════════════════════════════════════════════════════════════╝{reset}\n"
            f"  {gray}Created by: {white}@sinvy888{reset}\n"
        )
...
{Colors.LIGHTGREEN_EX}[+] Security{Colors.RESET}
  ...
  {Colors.WHITE}CONFIG BY: @sinvy888{Colors.RESET}
""".strip()
...
def main():
    ...
    console.print(f"[dim]Config by @sinvy888[/dim]\n")
